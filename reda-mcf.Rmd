...
```{r plot-sampleMcf, echo = FALSE, fig.path = 'images/', fig.show = 'hide', fig.width = 3, fig.height = 2.55}
...
mcfDiff.test(re_mcf)
```
```{r mcfdiffplot, echo = FALSE, fig.path = 'images/', fig.show = 'hide', fig.width = 4, fig.height = 3.45}
plot(mcfDiff(re_mcf))
```
