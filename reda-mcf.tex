...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{re_mcf <-}\StringTok{ }\NormalTok{reda::}\KeywordTok{mcf}\NormalTok{(fn, }\DataTypeTok{data =} \NormalTok{df0)}
...
\StringTok{    }\NormalTok{ggplot2::}\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position =} \StringTok{"bottom"}\NormalTok{) }\CommentTok{# Figure 3}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{reda::}\KeywordTok{mcfDiff.test}\NormalTok{(re_mcf)}
\end{Highlighting}
\end{Shaded}
